...
public class MainGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabPane.addTab("Add books", addPanel);
    ...
    private void butAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butAddActionPerformed
        ...
        if (radFiction.isSelected()) {
            ...
            NonFiction nonFictionBook = (NonFiction) book;
    ...
    //clear all text fields, select radDum, select first option in all comboBoxes
    ...
    //executes when a new topic is selected.
    //set options on comboSubTopic to sub topics of general topic
    ...
    //opens window for adding new authors
    ...
    //opens window for adding a new Series to the database
